...
// unxmlCommon.
    ...
    xpath.evaluate = xpathEval;
    xpath.select = xpathDomEval;
    xpath.BinaryExpr = BinaryExpr;
    xpath.ExprContext = ExprContext;
    /**
     * @param {XNode} node
     * @returns {ExprContext}
     */
    xpath.createContext = function(node) {
        return new ExprContext(node)
    };
    xpath.BooleanValue = BooleanValue;
    xpath.FilterExpr = FilterExpr;
    xpath.LiteralExpr = LiteralExpr;
    xpath.LocationExpr = LocationExpr;
    xpath.NodeSetValue = NodeSetValue;
    xpath.NodeTestAny = NodeTestAny;
    xpath.NodeTestComment = NodeTestComment;
    xpath.NodeTestElementOrAttribute = NodeTestElementOrAttribute;
    xpath.NodeTestName = NodeTestName;
    xpath.NodeTestNC = NodeTestNC;
    xpath.NodeTestPI = NodeTestPI;
    xpath.NodeTestText = NodeTestText;
    xpath.NumberExpr = NumberExpr;
    xpath.NumberValue = NumberValue;
    xpath.PathExpr = PathExpr;
    xpath.PredicateExpr = PredicateExpr;
    xpath.StepExpr = StepExpr;
