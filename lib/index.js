//browser support
if (typeof window === 'undefined') { var xmlCommon = require('./common'), xmlUtil = require('./util'), xpath = require('./xpath'); }
 ...
 * @param {*=} options
 */
Date.prototype.writeXml = function(parent, options) {
    if (typeof parent === 'undefined' || parent==null)
        return;
    if (parent.nodeType==1) {
        parent.appendChild(parent.ownerDocument.createTextNode(this.toXMLString()));
 ...
 * @param {*=} options
 */
Array.prototype.writeXml = function(parent, options) {
    if (typeof parent === 'undefined' || parent==null)
        return;
